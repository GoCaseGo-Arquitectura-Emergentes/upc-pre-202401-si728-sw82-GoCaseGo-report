...
[![User Persona](https://raw.githubusercontent.com/GoCaseGo-Arquitectura-Emergentes/upc-pre-202401-si728-sw82-GoCaseGo-report/feature/chapter-2/Resources/needfinding/User_Persona.png)](https://raw.githubusercontent.com/GoCaseGo-Arquitectura-Emergentes/upc-pre-202401-si728-sw82-GoCaseGo-report/feature/chapter-2/Resources/needfinding/User_Persona.png)

### 2.3.2. User Task Matrix
<div align="center">
    <table style="table-layout: fixed; width: 636px">
        <colgroup>
        ...
        <thead>
          <tr>
            ...
            <th colspan="2">Agencia de viajes <br> Raul Diaz <br></th>
          </tr>
          <tr>
            <th>Frecuencia</th>
            <th>Importancia</th>
        ...
        <tbody>
          <tr>
            <td>Búsqueda y selección de paquetes de viaje<br></td>
            <td>Media</td>
            <td>Mucha</td>
          </tr>
          <tr>
            <td>Selección de paquete de viaje<br></td>
            <td>Mucha</td>
            <td>Mucha</td>
          </tr>
          <tr>
            <td>Administración del peso del equipaje<br></td>
            <td>Mucha</td>
            <td>Mucha</td>
          </tr>
          <tr>
          ...
          <tr>
            <td>Resolución de problemas durante el viaje<br></td>
            <td>Mucha</td>
            <td>Mucha<br></td>
          </tr>
        </tbody>
...
Vamos a evaluar nuestros segmentos de interés utilizando mapas de empatía. <br>
Esto nos permitirá comprender mejor a nuestra audiencia objetivo y descubrir sus necesidades más fundamentales.

<strong>Segmento Agencias de Viaje</strong><br>
[![User Persona.](https://raw.githubusercontent.com/GoCaseGo-Arquitectura-Emergentes/upc-pre-202401-si728-sw82-GoCaseGo-report/feature/chapter-2/Resources/needfinding/Empathy_Map.png)](https://raw.githubusercontent.com/GoCaseGo-Arquitectura-Emergentes/upc-pre-202401-si728-sw82-GoCaseGo-report/feature/chapter-2/Resources/needfinding/Empathy_Map.png)

### 2.3.4. As-is Scenario Mapping

<strong>Segmento Agencias de Viaje</strong><br>
[![User Persona.](https://raw.githubusercontent.com/GoCaseGo-Arquitectura-Emergentes/upc-pre-202401-si728-sw82-GoCaseGo-report/feature/chapter-2/Resources/needfinding/As-Is_Scenario_Map.jpg)](https://miro.com/app/board/uXjVKUunw0Y=/?share_link_id=382331936109)
...
<div align="center">
    <table style="table-layout: fixed; width: 636px">
        ...
        <tbody>
            <tr>
                <td><strong>Candidate Context Discovery</strong></td>
                <td>En esta sección, el equipo explora el dominio del negocio utilizando técnicas como EventStorming para identificar los distintos contextos delimitados. Se pueden emplear varias técnicas como "start-with-value", "start-with-simple" o "look-for-pivotal-events". Esta sesión no debería exceder las 2 horas y se recomienda utilizar la herramienta adecuada.</td>
            </tr>
            <tr>
                <td><strong>Domain Message Flows Modeling</strong></td>
                <td>En esta sección, el equipo explica y evidencia el proceso seguido para visualizar cómo deben colaborar los bounded contexts para resolver los casos que se presentan en el negocio para los usuarios del sistema. Para ello debe aplicar la técnica de visualización Domain Storytelling. Complemente la explicación con capturas en imágenes de los diagramas de Domain Storytelling elaborados.</td>
            </tr>
            <tr>
                <td><strong>Bounded Context Canvases</strong></td>
                <td>En esta sección, el equipo diseña sus candidate bounded contexts, detallando los criterios de diseño. El equipo debe ir seleccionando cada bounded context, por orden de importancia, para elaborar su Bounded Context Canvas. La elaboración del Bounded Context Canvas debe seguir un proceso iterativo con los pasos de Context Overview Definition, Business Rules Distillation & Ubiquitous Language Capture, Capability Analysis, Capability Layering (si aplica), Dependencies Capture, y Design Critique.</td>
            </tr>
            <tr>
                <td><strong>Context Mapping</strong></td>
                <td>En esta sección, el equipo explica cómo crea mapas de contexto para visualizar las relaciones entre los contextos delimitados. Revisan la información recolectada para generar diseños candidatos, considerando movimientos de capacidades entre contextos, divisiones y fusiones de contextos. Al final, discuten cada opción para encontrar la mejor solución, considerando los patrones de relaciones entre contextos establecidos en el diseño dirigido por el dominio.</td>
            </tr>
            <tr>
                <td><strong>Software Architecture</strong></td>
                <td>En esta sección, el equipo presenta y explica la representación, aplicando C4 Model y utilizando la herramienta indicada, de la Arquitectura de Software para la solución. Aquí se realiza una introducción y se incluye como secciones internas Software Architecture Context Level Diagram y Software Architecture Container Level Diagrams.</td>
            </tr>
            <tr>
                <td>Software Architecture System Landscape Diagram</td>
                <td>Este diagrama proporciona una vista general de alto nivel del sistema y su entorno. Muestra los principales componentes del sistema, como módulos, subsistemas o servicios, junto con los sistemas externos con los que interactúa. Esta representación ayuda a comprender la arquitectura general del sistema y su contexto operativo.</td>
            </tr>
            <tr>
                <td><strong>Software Architecture Context Level Diagram</strong></td>
                <td>En esta sección, el equipo realiza una introducción, presenta en imagen el context diagram, el cual debe mostrar el sistema como un recuadro en el centro, rodeado por sus usuarios y otros sistemas con los que interactúa. Utilice la herramienta indicada para la elaboración del diagrama. Se incluye en esta sección una explicación del diagrama.</td>
            </tr>
            <tr>
                <td><strong>Software Architecture Container Level Diagram</strong></td>
                <td>En esta sección, el equipo realiza una introducción, presenta y explica el Container Diagram. Dicho diagrama debe mostrar los elementos de alto nivel de la arquitectura de software y cómo se distribuyen las responsabilidades entre ellos. Aquí se debe mostrar también las principales decisiones de tecnología y cómo los containers se comunican entre sí.</td>
            </tr>
            <tr>
                <td>Software Architecture Deployment Diagrams</td>
                <td>Estos diagramas muestran cómo se despliegan físicamente los distintos componentes del sistema en infraestructura de hardware y software. Detallan la distribución de los componentes en servidores físicos, máquinas virtuales, contenedores o en la nube, así como las conexiones entre ellos. Esto es útil para comprender cómo se implementa y ejecuta el sistema en su entorno de producción.</td>
            </tr>
        </tbody>
    </table>
</div>
